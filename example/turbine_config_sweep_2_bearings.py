...
df_hierarchical.to_csv("turbine_config_csm_sweep_2_bearings.csv", encoding="utf-8-sig")

print("The updated hybrid data frame has been generated and written to 'turbine_config_csm_sweep_2_bearings.csv'")